...
Feature: Put
  ...
  Scenario: User success put first name data
    ...
    When User sends a PUT request to update the user with id "60d0fe4f5311236168a109cd" and the following data:
  ...
  Scenario: User success put email data
    Given The user API is available
    When User sends a PUT request to update the user with id "60d0fe4f5311236168a109cd" and email data:
